"""Creation of a table (DataFrame) of the loaded data in LaTeX format.

CAUTION: Need \usepackage{booktabs}, \usepackage{longtable} in file .tex"""
...
tab_latex = table.to_latex(index=False,
